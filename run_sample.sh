...
# test
python wmseg_main.py --do_test --eval_data_path=./sample_data/test.tsv --eval_model=./models/model.pt

# predict
python wmseg_main.py --do_predict --input_file=./sample_data/sentence.txt --eval_model=./models/model.pt
